...
OUTPUT_TENSOR_FILE = "./output/embedding_tensor_cbow.npy"
OUTPUT_MAP_FILE = "./output/embedding_token_to_index_map.json"
OUTPUT_MODEL_FILE = "./output/embedding_word2vec_cbow_model.model"
